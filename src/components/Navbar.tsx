      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          <Link to="/" className="flex items-center gap-2 font-bold text-xl">
            ...
            <span className="bg-gradient-to-r from-primary to-blue-400 bg-clip-text text-transparent px-[27px]">
              Brighter Risk Pro
            </span>
          </Link>
          ...
          <div className="flex gap-1">
            ...
            <Link to="/trades" className={`
                px-4 py-2 rounded-md flex items-center gap-2 transition-all
                ${isActive("/trades") ? "bg-primary text-primary-foreground shadow-lg" : "text-muted-foreground hover:text-foreground hover:bg-accent"}
              `}>
