  ...
  return (
    <DashboardLayoutWrapper>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2 font-montserrat">Carteira Mensal</h1>
        ...
        {user && dashboardId && (
          <Card className="p-6 mb-8">
            <StockPnLEvolutionChart userId={user.id} dashboardId={dashboardId} defaultPeriod="month" />
          </Card>
        )}
        ...
        <Card className="p-6">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl font-semibold">Trades do Mês</h2>
          ...
          {trades.length === 0 ? (
            <p className="text-muted-foreground text-center py-8">
              Nenhum trade registrado neste mês.
            </p>
          ) : (
            <Table>
              <TableHeader>
