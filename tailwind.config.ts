  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": { boxShadow: "0 0 16px hsl(39 82% 47% / 0.1)" },
          "50%": { boxShadow: "0 0 24px hsl(39 82% 47% / 0.2)" },
        },
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 20px -5px hsl(39 82% 47% / 0.2)" },
          "50%": { boxShadow: "0 0 30px -5px hsl(39 82% 47% / 0.4)" },
        },
        "fade-in-up": {
